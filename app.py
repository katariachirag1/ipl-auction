...
def _get_teams_data():
    ...
    return {
        ...
        "DC": [
            ...
            ("Tristan Stubbs", "WK", 1), ("Ben Duckett", "WK", 1), ("Abishek Porel", "WK", 1),
        ...
        "GT": [
            ...
            ("Prasidh Krishna", "Bowler", 1), ("Ravisrinivasan Sai Kishore", "Bowler", 1), ("Manav Suthar", "Bowler", 1),
        ...
        "KKR": [
            ("Rinku Singh", "Batsman", 2), ("Sunil Narine", "All-rounder", 2), ("Varun Chakaravarthy", "Bowler", 2),
        ...
        "PBKS": [
            ...
            ("Prabhsimran Singh", "WK", 1), ("Vishnu Vinod", "WK", 1), ("Priyansh Arya", "Batsman", 1),
            ("Harnoor Pannu", "Batsman", 1), ("Mitchell Owen", "Batsman", 1), ("Pyla Avinash", "Batsman", 1),
        ...
        "RCB": [
            ("Virat Kohli", "Batsman", 2), ("Rajat Patidar", "Batsman", 2), ("Philip Salt", "WK", 2), ("Josh Hazlewood", "Bowler", 2),
        ...
        "SRH": [
            ...
            ("Ishan Kishan", "WK", 2), ("Nitish Kumar Reddy", "All-rounder", 2), ("Harshal Patel", "Bowler", 1),
